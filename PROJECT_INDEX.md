...
|---|---|---|---|
| [AX Downloader](projects/AX_DOWNLOADER.md) | Aktif geliştirme / gerçek WinUI + Worker + IPC + SQLite | C# CP-001→CP-042 Windows kabulü tamamlandı | CP-043 Safe Empty Queue Deletion sözleşmesini dondur ve ilk kabulü full koş |
