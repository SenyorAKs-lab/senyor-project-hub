...
| Proje | Durum | Son doğrulanan aşama | Sıradaki ana adım |
|---|---|---|---|
| [AX Downloader](projects/AX_DOWNLOADER.md) | Aktif prototip | Windows yeniden başlatma sonrası paralel resume testi geçti | Kontrollü HTTP 429 adaptif bağlantı düşürme testi |
